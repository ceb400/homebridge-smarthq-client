 ...
 */
export declare class InteriorLight {
    ...
    getFridgeBackLight(): Promise<CharacteristicValue>;
    setFridgeBackLight(value: CharacteristicValue): Promise<void>;
    getRefrigBrightnessLightOn(): Promise<boolean>;
    setRefrigBrightnessLightOn(value: CharacteristicValue): Promise<void>;
}
